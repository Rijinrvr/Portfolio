...
export default function AboutMe() {
  return (
    <section id="AboutMe" className="w-full py-12 sm:py-20 px-4 sm:px-10 bg-white">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-6 sm:gap-10">
